<?php $__env->startSection('title', 'Signal & Analytics | DragonFortune'); ?>
    ...
    <div class="df-panel p-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <p class="text-muted small mb-0">Rule-based signal performance (<?php echo e(config('signal.label_horizon_hours',24)); ?>h horizon).</p>
            </div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('signalAnalytics', () => ({
        ...
        pollTimer: null,
        pollMs: 5 * 60 * 1000,
        apiUrl: '<?php echo e(route('api.signal.analytics')); ?>',
        backtestApi: '<?php echo e(route('api.signal.backtest')); ?>',
        historyApi: '<?php echo e(route('api.signal.history')); ?>',
        backtest: null,
        symbols: <?php echo json_encode(array_values(config('signal.symbols', ['BTC'])), 512) ?>,
        init() {
            this.fetchData();
            this.fetchBacktest();
             this.fetchHistory();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/dragonfortune/resources/views/signal-analytics/dashboard.blade.php ENDPATH**/ ?>