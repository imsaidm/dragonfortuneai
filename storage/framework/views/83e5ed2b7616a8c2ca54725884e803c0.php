<?php $__env->startSection('title', 'On-Chain Metrics | DragonFortune'); ?>
...
<div class="d-flex flex-column h-100 gap-3" x-data="onChainMetrics()">
    ...
    <div class="tab-content">
        <?php echo $__env->make('onchain-metrics.tabs.exchange-assets', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('onchain-metrics.tabs.exchange-balances', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('onchain-metrics.tabs.chain-transactions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('onchain-metrics.tabs.whale-transfers', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/dragonfortune/resources/views/onchain-metrics/dashboard.blade.php ENDPATH**/ ?>