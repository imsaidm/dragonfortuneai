<?php $__env->startSection('title', 'Exchange Inflow CDD | DragonFortune'); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="module">
        ...
        import { CDDUtils } from '<?php echo e(asset('js/exchange-inflow-cdd/utils.js')); ?>';
        import { ExchangeInflowCDDAPIService } from '<?php echo e(asset('js/exchange-inflow-cdd/api-service.js')); ?>';
        import { ChartManager } from '<?php echo e(asset('js/exchange-inflow-cdd/chart-manager.js')); ?>';
        import { createCDDController } from '<?php echo e(asset('js/exchange-inflow-cdd/controller.js')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/dragonfortune/resources/views/derivatives/exchange-inflow-cdd.blade.php ENDPATH**/ ?>