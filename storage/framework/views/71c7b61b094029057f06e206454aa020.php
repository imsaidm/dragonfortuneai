<?php $__env->startSection('title', 'Funding Rate | DragonFortune'); ?>
...
<?php $__env->startPush('head'); ?>
    ...
    <link rel="preload" href="<?php echo e(asset('js/funding-rate-exact-controller.js')); ?>" as="script" type="module">
    
    <!-- Prefetch API endpoints (will fetch in background during hard refresh) -->
    <link rel="prefetch" href="<?php echo e(config('app.api_urls.internal')); ?>/api/funding-rate/history?symbol=BTCUSDT&exchange=Binance&interval=8h&limit=100" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="<?php echo e(config('app.api_urls.internal')); ?>/api/funding-rate/analytics?symbol=BTCUSDT&exchange=Binance&interval=8h&limit=100" as="fetch" crossorigin="anonymous">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="module" src="<?php echo e(asset('js/funding-rate-exact-controller.js')); ?>" defer></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/dragonfortune/resources/views/derivatives/funding-rate-exact.blade.php ENDPATH**/ ?>