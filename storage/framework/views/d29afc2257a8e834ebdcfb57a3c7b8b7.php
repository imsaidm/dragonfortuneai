<?php $__env->startSection('title', 'ETF Flows | DragonFortune'); ?>
...
<?php $__env->startPush('head'); ?>
    ...
    <link rel="preload" href="<?php echo e(asset('js/etf-flows/controller-coinglass.js')); ?>?v=<?php echo e(time()); ?>" as="script" crossorigin="anonymous">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="module">
        ...
        import { EtfFlowsAPIService } from '<?php echo e(asset('js/etf-flows/api-service.js')); ?>';
        import { ChartManager } from '<?php echo e(asset('js/etf-flows/chart-manager.js')); ?>';
        import { EtfFlowsUtils } from '<?php echo e(asset('js/etf-flows/utils.js')); ?>';
            ...
            return {
                ...
                async loadPremiumDiscount() {
                    ...
                    if (!this.pdChartManager) {
                        const { PremiumDiscountChartManager } = await import('<?php echo e(asset('js/etf-flows/premium-discount-chart.js')); ?>');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/dragonfortune/resources/views/etf-flows/dashboard.blade.php ENDPATH**/ ?>