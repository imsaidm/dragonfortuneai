<?php $__env->startSection('title', 'Basis & Term Structure | DragonFortune'); ?>
...
<?php $__env->startPush('head'); ?>
    ...
    <link rel="preload" href="<?php echo e(asset('js/basis-term-structure-controller.js')); ?>" as="script" type="module">
    
    <!-- Prefetch API endpoints (will fetch in background during hard refresh) -->
    <link rel="prefetch" href="<?php echo e(config('app.api_urls.internal')); ?>/api/basis/history?exchange=Binance&spot_pair=BTC/USDT&futures_symbol=BTCUSDT&interval=1h&limit=100" as="fetch" crossorigin="anonymous">
    <link rel="prefetch" href="<?php echo e(config('app.api_urls.internal')); ?>/api/basis/analytics?exchange=Binance&spot_pair=BTC/USDT&futures_symbol=BTCUSDT&interval=1h&limit=100" as="fetch" crossorigin="anonymous">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="module" src="<?php echo e(asset('js/basis-term-structure-controller.js')); ?>" defer></script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/dragonfortune/resources/views/derivatives/basis-term-structure.blade.php ENDPATH**/ ?>